...
export function TestsAdd({id, name, description, questions} : TestsAddProps) {
    ...
    return (
        <body className="body">
                        ...
                        <li className="question">
                            ...
                            <nav className="question-type-nav">
                                <div className="question__title">
                                    <input type="text" className="question__title" value="Новый заголовок"/>
                                </div>
                            ...
                            <ul className="list__answers">
                                ...
                                <span className="answer__prepend radio">
                                    ...
                                    <div className="answer__title">
                                        <input type="text" className="answer__title" value="Новый заголовок"/>
                                    </div>
                                ...
                                <span className="answer__prepend radio">
                                    ...
                                    <div className="answer__title">
                                        <input type="text" className="answer__title" value="Добавить вариант"/>
                                    </div>
                                    <span className="answer__append">
                                    <img src="./img/image.png"/>
                                    <img src="./img/delete.png"/>
            ...
            <Button onClick={addNew}>Создать тест</Button>
        </body>
    )
}